                ...
                >
                    ...
                    <div className="form-group">
                        ...
                        <select
                            ...
                            required
                            defaultValue={
                                editingQuiz?.difficulty_id?.toString() ?? ""
                            }
                        >
                            <option value="" disabled>
                                Select Difficulty
                    ...
                    {selectedTypeName === "FITB" && (
                        <div className="form-group">
                            ...
                            <input
                                ...
                                className="form-input"
                                defaultValue={
                                    editingQuiz?.quiz_payload?.answer ?? ""
                                }
                                required
                            />
                        </div>
                    ...
                    {selectedTypeName === "Pair" && (
                        <div className="form-group">
                            <label style={{ marginBottom: "12px" }}>
                                Matching Pairs (Enter Left and matching Right
                                values)
                            </label>
                            <div className="options-grid">
                                {[0, 1, 2, 3].map((idx) => (
