  ...
  return (
    <nav className={menuOpen ? "menu-open" : ""}>
      ...
      <div className="accessibility">
        <div>
          <button data-accessibility-trigger type="button" aria-label={accessibilityOpen ? "Close accessibility options" : "Open accessibility options"} onClick={() => setAccessibilityOpen((isOpen) => !isOpen)}>
