...
export default function IncomingQuizCard({ initialQuizzes }: { initialQuizzes: PendingQuiz[] }) {
  ...
  const [viewedNoteId, setViewedNoteId] = useState<number | null>(null);
